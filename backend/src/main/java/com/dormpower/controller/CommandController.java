...
public class CommandController {
    ...
    public ResponseEntity<Map<String, Object>> sendBatchCommand(
        ...
        Map<String, Object> response = commandService.sendBatchCommand(request.getDeviceIds(), request.getCommand());
        ...
        if (commandIds != null) {
            for (Map.Entry<String, String> entry : commandIds.entrySet()) {
                ...
                Map<String, Object> payload = new HashMap<>(request.getCommand());
                payload.put("cmdId", cmdId);
