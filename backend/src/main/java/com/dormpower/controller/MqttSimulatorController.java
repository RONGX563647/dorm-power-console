...
public class MqttSimulatorController {
    ...
    @GetMapping("/tasks")
    public ResponseEntity<List<MqttSimulatorTaskSummary>> getAllSimulatorTasks() {
        List<MqttSimulatorTaskSummary> tasks = mqttSimulatorService.getAllSimulatorTaskSummaries();
